...
class FriendListViewModel: CommonViewModel {
    ...
    init(myInfo: User, sceneCoordinator: SceneCoordinatorType, firebaseUtil: FirebaseUtil) {
        ...
        profileInfoSubject = BehaviorSubject<[User]>(value: [
                                                        myInfo,
                                                        User(email: "test1", uid: "test1", id: "test1", profileImg: UIImage(named: "defaultProfileImage.png")),
                                                        User(email: "test2", uid: "test2", id: "test2", profileImg: UIImage(named: "defaultProfileImage.png"))
        ])
